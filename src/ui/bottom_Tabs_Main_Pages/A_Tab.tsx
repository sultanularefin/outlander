...
const A_Tab: React.FC<IXprez_Props> = ({
                                                 navigation,
                                                 route,
                                             }) => {
    ...
    return (
        <View style={A_Tab_Styles.container}>
...
const A_Tab_Styles = StyleSheet.create({
